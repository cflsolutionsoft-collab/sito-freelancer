...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* Menu mobile — overlay fisso sotto l'header.
          Tenuto FUORI dal tag <header> per evitare che l'header sticky
          diventi piu alto del viewport (comportamento CSS di sticky con
          contenuto alto: l'header scorre insieme alla pagina invece di
          restare ancorato in cima). */}
      {menuOpen && (
        <nav
          className="animate-fade-in-up fixed inset-x-0 top-[69px] z-40 max-h-[calc(100dvh-69px)] overflow-y-auto border-b border-border/60 bg-background px-4 pb-6 pt-4 shadow-lg md:hidden"
        >
